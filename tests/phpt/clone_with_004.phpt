...
echo PHP_EOL;
var_dump(Kenny1911\CloneWith\clone_with($c, [ 'hooked' => 'updated', 'maxLength' => 'abc', 'minLength' => 'abcdef' ]));
echo PHP_EOL;
var_dump(Kenny1911\CloneWith\clone_with($c, [ 'minLength' => 'abcdef', 'hooked' => 'updated', 'maxLength' => 'abc' ]));
